...
class Turbulence(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Turbulence")
        ...
        # Variables
        ##################################################
        self.wavelen = wavelen = 850
        self.samp_rate = samp_rate = 32000
        self.rx_dia = rx_dia = 50
        self.linklen = linklen = 100
        self.jitter = jitter = 200
        self.Cn2 = Cn2 = math.log(1e-15)

        ##################################################
        # Blocks
        ##################################################
        self._wavelen_range = Range(400, 1600, 0.1, 850, 200)
        self._wavelen_win = RangeWidget(self._wavelen_range, self.set_wavelen, 'Wavelength (nm)', "counter_slider", float)
        self.top_grid_layout.addWidget(self._wavelen_win)
        ...
        self._Cn2_range = Range(math.log(1e-20), math.log(1e-10), 0.01, math.log(1e-15), 200)
        self._Cn2_win = RangeWidget(self._Cn2_range, self.set_Cn2, 'Cn2 (m^-2/3)', "counter_slider", float)
        self.top_grid_layout.addWidget(self._Cn2_win)
        ...
        self.FSO_Comm_Turbulence_0 = FSO_Comm.Turbulence(math.exp(Cn2), wavelen, rx_dia, linklen, 10.0, samp_rate)
        ...
        # Connections
        ##################################################
        self.connect((self.FSO_Comm_Turbulence_0, 0), (self.qtgui_time_sink_x_0, 1))
        self.connect((self.analog_sig_source_x_0, 0), (self.blocks_throttle_0, 0))
        self.connect((self.blocks_throttle_0, 0), (self.FSO_Comm_Turbulence_0, 0))
    ...
    def set_wavelen(self, wavelen):
        ...
        self.FSO_Comm_Turbulence_0.set_Wavelength(self.wavelen)
    ...
    def set_Cn2(self, Cn2):
        self.Cn2 = Cn2
        self.FSO_Comm_Turbulence_0.set_Cn2(self.Cn2)



def main(top_block_cls=Turbulence, options=None):
