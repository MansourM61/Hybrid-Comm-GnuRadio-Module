...
class Geometric_Loss(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Geometric_Loss")
        ...
        self._theta_range = Range(0, 10, 0.01, 0.1, 200)
        ...
        self.FSO_Comm_Geometric_Loss_0 = FSO_Comm.Geometric_Loss(tx_dia, theta, rx_dia, linklen)
        ...
        # Connections
        ##################################################
        self.connect((self.FSO_Comm_Geometric_Loss_0, 0), (self.qtgui_time_sink_x_0, 1))
        self.connect((self.analog_sig_source_x_0, 0), (self.blocks_throttle_0, 0))
        self.connect((self.blocks_throttle_0, 0), (self.FSO_Comm_Geometric_Loss_0, 0))
    ...
    def set_tx_dia(self, tx_dia):
        self.tx_dia = tx_dia
        self.FSO_Comm_Geometric_Loss_0.set_DiaTx(self.tx_dia)
    ...
    def set_theta(self, theta):
        self.theta = theta
        self.FSO_Comm_Geometric_Loss_0.set_ThetaTx(self.theta)
    ...
    def set_rx_dia(self, rx_dia):
        self.rx_dia = rx_dia
        self.FSO_Comm_Geometric_Loss_0.set_DiaRx(self.rx_dia)
    ...
    def set_linklen(self, linklen):
        ...
        self.FSO_Comm_Geometric_Loss_0.set_LinkLen(self.linklen)



def main(top_block_cls=Geometric_Loss, options=None):
